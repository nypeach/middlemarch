      ...
      >
        ...
        <Modal.Header>
          <Modal.Title id={props.person.id}>
            <p className="team-modal-header">&nbsp;&nbsp; {props.person.name} | {props.person.title} &nbsp;&nbsp;&nbsp;&nbsp;
              ...
              {/* <i class="fas fa-phone" style={{ cursor: "pointer" }} onClick={(e) => {
                e.preventDefault();
                window.open(`${props.person.phone}`)
              }}></i>&nbsp;&nbsp;&nbsp;&nbsp; */}
        ...
        <Modal.Body>
          <div style={{ textAlign: "left", margin: "16px"}}>
            ...
            <div><p className="team-modal"><strong>Expertise: </strong>{props.person.expertise}</p></div>
