  ...
  return (
    <div className="our-firm-tiles">
      ...
      <div class="card-deck justify-content-center">
        <div class="card justify-content-center border-0" style={{ maxWidth: "35%" }} onClick={isMerchOpenToggle}>
        ...
        <div class="card justify-content-center  border-0" style={{ maxWidth: "35%" }} onClick={isPrivOpenToggle}>
