    ...
    <div className="our-firm-tiles">
      ...
      <div className="container">
        <div className="row" onClick={isMerchOpenToggle}>
          ...
          <div className="column column-text">The merchant banking model combines the capital raising and M&amp;A advisory services of an investment bank with the ability to invest like a private equity fund in client companies.&nbsp;&nbsp;<button className="read-more-link" style={{ fontSize: "2rem" }} onClick={isMerchOpenToggle}>Read More ...</button></div>
        </div>
        <div className="row" onClick={isPrivOpenToggle}>
          ...
          <div className="column column-text">The principals of Middlemarch Capital Partners, the firm’s investment arm, can either co-invest alongside top-tier sponsors or lead investments.&nbsp;&nbsp;<button className="read-more-link" style={{ fontSize: "2rem" }} onClick={isPrivOpenToggle}>Read More ...</button></div>
        </div>
      </div>
