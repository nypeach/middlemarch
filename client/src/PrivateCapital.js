...
import privCapCustom from './images/ourFirm/private_capital_blank.svg';
        ...
        <Container fluid style={{ paddingLeft: "0", paddingRight:"0" }}>
          <Row style={{padding: "3rem", alignItems: "center"}}>
            ...
            <Col xs={6}>
              ...
              <div className="private-capital-text">The firm actively supports investments via board and advisory roles, assisting management teams as they drive growth and shareholder value.</div>
            </Col>
          </Row>
        </Container>
